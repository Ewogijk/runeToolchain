...
namespace Forge {
    Ember::StatusCode system_call0(Ember::Handle handle) {
        ...
        __asm__ __volatile__("syscall" : "=a"(ret) : "a"(handle) : "rcx", "r11", "memory");
        return ret;
    }

    Ember::StatusCode system_call1(Ember::Handle handle, Ember::SystemCallArgument arg1) {
        Ember::StatusCode ret = -1;
    ...
    Ember::StatusCode system_call6(Ember::Handle             handle,
                                   Ember::SystemCallArgument arg1,
                                   Ember::SystemCallArgument arg2,
                                   Ember::SystemCallArgument arg3,
                                   Ember::SystemCallArgument arg4,
